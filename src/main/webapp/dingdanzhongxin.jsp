<%@ page import="com.sure.mi.model.Transaction" %>
    ...
    <div class="selfinfo center">
        ...
        <div class="rtcont fr">
            ...
            <div class="ddxq">
                ...
                <div class="ddbh fl">订单号:<%=transaction.getId()%>></div>
                <div class="ztxx fr">
                    <ul>
                        <li><%if (transaction.getState() == 0){%>等待支付<%}%>
                            <%if (transaction.getState() == 1){%>等待发货<%}%>
                            <%if (transaction.getState() == 2){%>已发货<%}%></li>
                        <li><%=transaction.getPrice()%>元</li>
                        <li><%=simpleDateFormat.format(transaction.getCreatedAt())%></li>
                        <li><a href="">订单详情></a></li>
                        <div class="clear"></div>
                    </ul>
                </div>
